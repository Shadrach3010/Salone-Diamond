...
var ASM_CONSTS = {
  4535140: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4535195: ($0) => { performance.now = function() { return $0; }; },  
 4535243: ($0) => { performance.now = function() { return $0; }; },  
 4535291: () => { performance.now = Module['emscripten_get_now_backup']; }
};
