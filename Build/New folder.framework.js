...
var ASM_CONSTS = {
  4536212: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4536267: ($0) => { performance.now = function() { return $0; }; },  
 4536315: ($0) => { performance.now = function() { return $0; }; },  
 4536363: () => { performance.now = Module['emscripten_get_now_backup']; }
};
