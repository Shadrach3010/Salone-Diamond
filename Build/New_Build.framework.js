...
var ASM_CONSTS = {
  3571144: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3571199: ($0) => { performance.now = function() { return $0; }; },  
 3571247: ($0) => { performance.now = function() { return $0; }; },  
 3571295: () => { performance.now = Module['emscripten_get_now_backup']; }
};
